...
public class SoctLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "RUN", "BIND", "COMPOSITION", "SEND", "REPLICATED_RECEIVE", "RECEIVE", 
			"COMMA", "LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "CHANNEL"
		};
	}
	...
	public SoctLexer(CharStream input) {
		super(input);
